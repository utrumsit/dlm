...
CATEGORY_INFO = {
    ...
    "700_Arts": {"name": "Arts", "ddc": "700", "default_subjects": ["Arts"]},
    "780_Music": {"name": "Music", "ddc": "780", "default_subjects": ["Music"]},
    "790_Recreation": {
...
DDC_SUBCATEGORIES = {
    ...
    "006_Artificial_Intelligence": {
        "ddc": "006.3",
        "subjects": ["Artificial Intelligence", "Machine Learning", "AI"],
    },
    "220_Scripture": {"ddc": "220", "subjects": ["Scripture", "Bible"]},
    "264_Liturgy": {"ddc": "264", "subjects": ["Liturgy", "Worship"]},
    "270_Patristics": {
        "ddc": "270",
        "subjects": ["Patristics", "Church Fathers", "Church History"],
    },
    "470_Latin": {"ddc": "470", "subjects": ["Latin", "Classical Latin"]},
    "480_Greek": {
        "ddc": "480",
        "subjects": ["Greek", "Ancient Greek", "Classical Greek"],
    },
    ...
    "630_Agriculture_Homesteading": {
        "ddc": "630",
        "subjects": ["Agriculture", "Homesteading", "Farming"],
    },
    "640_Home_Economics": {
        "ddc": "640",
        "subjects": ["Home Economics", "Self-Sufficiency", "DIY"],
    },
    ...
    "796_Athletics": {
        "ddc": "796",
        "subjects": ["Athletics", "Sports", "Physical Training"],
    },
}
...
def extract_pdf_metadata(filepath):
    ...
    try:
        result = subprocess.run(
            ["pdfinfo", str(filepath)], capture_output=True, text=True, timeout=5
        )
